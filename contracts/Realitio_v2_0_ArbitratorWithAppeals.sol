 ...
 */
contract Realitio_v2_0_ArbitratorWithAppeals is IDisputeResolver, IRealitioArbitrator {
    ...
    function requestArbitration(bytes32 _questionID, uint256 _maxPrevious) external payable returns (uint256 disputeID) {
        ...
        // Notify Realitio
        IRealitio_v2_0(realitio).notifyOfArbitrationRequest(_questionID, msg.sender, _maxPrevious);
    ...
    function computeWinnerAndReportAnswer(
        ...
        IRealitio_v2_0(realitio).submitAnswerByArbitrator(_questionID, bytes32(arbitrationRequest.answer - 1), computeWinner(_questionID, _lastAnswerOrCommitmentID, _lastBond, _lastAnswerer, _isCommitment, arbitrationRequest));
    }
